...
./trec_eval.9.0/trec_eval ./data/ClinicalTrials/qrels-treceval-trials.38.txt ./qresults/ct_results.txt > ../res.2019
#2017
./trec_eval.9.0/trec_eval ./data/ClinicalTrials/qrels-final-trials.txt ./qresults/results2.txt
